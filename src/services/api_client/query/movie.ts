...
import { getDetail, getMovie, getMovieRecommend } from "../interfaces/movie/movie_service";
...
export const useGetMovieRecommend = (id: number) => {
  return useQuery({
    queryKey: [`${id}-recommend`],
    queryFn: () => getMovieRecommend(id),
  });
};
